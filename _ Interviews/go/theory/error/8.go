...
// Если вы хотите, чтобы defer изменил возвращаемое значение функции, у функции в
// сигнатуре должен быть именованный возвращаемый параметр (`safeExecute() (err error)`),
