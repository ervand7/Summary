...
contract MyGovernorTest is Test {
    ...
    function testGovernanceUpdatesBox() public {
        ...
        console.log("Proposal State:", uint256(governor.state(proposalId))); // 0 (Pending)

        vm.warp(block.timestamp + VOTING_DELAY + 1);
        vm.roll(block.number + VOTING_DELAY + 1);

        console.log("Proposal State:", uint256(governor.state(proposalId))); // 1 (Active)
        ...
        console.log("Proposal State:", uint256(governor.state(proposalId))); // 4 (Succeeded)
