...
/*
Две горутины могут одновременно читать из одного канала через
...
Но wg и все с ним связанное в данной задаче выступает только запутывателем. Так
как его использование вообще не нужно.
Также нужно понимать, что и закрывать канал явно тоже не нужно.
*/
