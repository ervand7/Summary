...
Обычно ошибка «что-то пошло не так» возникает,
когда для объекта (или вложенного объекта) не заданы правила
сериализации (не реализован интерфейс json.Marshaler).
*/
