...
func main() {
	var varBool *bool
	fmt.Println(reflect.ValueOf(varBool))        // <nil>
	...
	fmt.Println(reflect.ValueOf(varFloat))        // 0
	...
	fmt.Println(reflect.ValueOf(varMap))        // map[]
	...
	fmt.Println(reflect.ValueOf(varStruct))        // {0}
