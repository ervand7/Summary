...
def reverse_array_not_in_place(array):
    ...
    for i in range(0, len_array):
        reverse_list[len_array - i - 1] = array[i]  # - 1 here to avoid IndexError
        # Now copy reversed
    for i in range(0, len_array):
...
def reverse_array_in_place(array):
    """
    Function to reverse arr[] from start to end.
    This needs O(1) extra space for exchanging
    elements and is an example of in-place algorithm.
    """
    len_array = len(array)
